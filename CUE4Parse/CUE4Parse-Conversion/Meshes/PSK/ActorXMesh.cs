...
public class ActorXMesh
{
    ...
    public ActorXMesh(ExporterOptions options)
    {
        ...
        var mainHdr = new VChunkHeader { TypeFlag = Constants.PSK_VERSION, ChunkId = "0" };
    ...
    private void ExportStaticMeshLods(CStaticMeshLod lod, List<MaterialExporter2>? materialExports, FPackageIndex[] sockets)
    {
        ...
        var infHdr = new VChunkHeader { ChunkId = "0" };
    ...
    {
        var mainHdr = new VChunkHeader { ChunkId = "0" };
        var ptsHdr = new VChunkHeader { ChunkId = "0" };
        var wedgHdr = new VChunkHeader { ChunkId = "0" };
        var facesHdr = new VChunkHeader { ChunkId = "0" };
        var matrHdr = new VChunkHeader { ChunkId = "0" };
        var normHdr = new VChunkHeader { ChunkId = "0" };
    ...
    {
        var boneHdr = new VChunkHeader { ChunkId = "0" };
    ...
    public void ExportVertexColors(FColor[]? colors, int numVerts)
    {
        ...
        var colorHdr = new VChunkHeader { DataCount = numVerts, DataSize = 4, ChunkId = "0" };
    ...
    {
        var uvHdr = new VChunkHeader { DataCount = numVerts, DataSize = 8, ChunkId = "0" };
    ...
    public void ExportMorphTargets(CSkelMeshLod lod, CVertexShare share, FPackageIndex[]? morphTargets, int lodIndex)
    {
        ...
        var morphInfoHdr = new VChunkHeader { DataCount = morphTargets.Length, DataSize = 64 + sizeof(int), ChunkId = "0" };
        ...
        var morphDataHdr = new VChunkHeader { DataCount = morphDeltas.Count, DataSize = Constants.VMorphData_SIZE, ChunkId = "0" };
    ...
    public void ExportSkeletalSockets(FPackageIndex[] sockets, List<CSkelMeshBone> bones)
    {
        ...
        switch (Options.SocketFormat)
        {
            case ESocketFormat.Socket:
                {
                    var socketInfoHdr = new VChunkHeader { DataCount = sockets.Length, DataSize = Constants.VSocket_SIZE, ChunkId = "0" };
