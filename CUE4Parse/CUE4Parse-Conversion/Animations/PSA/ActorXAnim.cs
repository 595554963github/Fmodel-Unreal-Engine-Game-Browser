...
public class ActorXAnim
{
    ...
    private void DoExportPsa(CAnimSet anim, int seqIdx)
    {
        ...
        {
            ChunkId = "ANIMHEAD",
            TypeFlag = Constants.PSA_VERSION
        };
        ...
        var boneHdr = new VChunkHeader
        {
            ChunkId = "BONENAMES",
            DataCount = numBones,
            DataSize = Constants.FNamedBoneBinary_SIZE
        };
        ...
        keyHdr.DataCount = sequence.NumFrames * numBones;
        ...
        if (mainHdr.TypeFlag >= 20090127)
        {
            ...
            {
                ChunkId = "SCALEKEYS",
                DataCount = keyHdr.DataCount,
                DataSize = Constants.VScaleAnimKey_SIZE
            };
