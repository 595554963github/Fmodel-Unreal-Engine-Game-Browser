...
namespace CUE4Parse.UE4.Objects.UObject
{
    ...
    public class FPackageFileSummary
    {
        ...
        internal FPackageFileSummary(FArchive Ar)
        {
            ...
            if (Tag == PACKAGE_FILE_TAG_NTE && Ar.Game == EGame.GAME_异环)
            {
            ...
            if (Tag == PACKAGE_FILE_TAG_SWAPPED)
            {
                ...
                throw new ParserException("不支持包的字节交换");
            }

            legacyFileVersion = Ar.Read<int>();
            if (Ar.Game == EGame.GAME_三角洲行动) legacyFileVersion /= 659;
            ...
            if (legacyFileVersion < 0) // means we have modern version numbers
            {
                ...
                if (Ar.Game == EGame.GAME_往日不再) FileVersionUE.FileVersionUE4 = 498;
            ...
            if (Ar.Game is EGame.GAME_无畏契约 or EGame.GAME_HYENAS_直译为鬣狗) Ar.Position += 8;
            ...
            if (Ar.Game == EGame.GAME_三角洲行动) Ar.Position += 16;
            ...
            if (Ar.Game == EGame.GAME_方舟_生存进化 && (int) FileVersionLicenseeUE >= 10)
            {
                Ar.Position += 8;
            }
            ...
            if (Ar.Game is EGame.GAME_盗贼之海 or EGame.GAME_战争机器4)
            {
            ...
            DataResourceOffset = FileVersionUE >= EUnrealEngineObjectUE5Version.DATA_RESOURCES || Ar.Game == EGame.GAME_第一后裔 ? Ar.Read<int>() : -1;
