...
public readonly struct FSoftObjectPath : IUStruct
{
    ...
    public FSoftObjectPath(FAssetArchive Ar)
    {
        ...
        AssetPathName = Ar.Ver >= EUnrealEngineObjectUE5Version.FSOFTOBJECTPATH_REMOVE_ASSET_PATH_FNAMES || Ar.Game == EGame.GAME_第一后裔 ? new FName(new FTopLevelAssetPath(Ar).ToString()) : Ar.ReadFName();
