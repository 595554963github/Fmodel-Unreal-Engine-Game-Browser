...
namespace CUE4Parse.UE4.Objects.Engine.Animation
{
    public class UBlendSpaceBase : UAnimationAsset
    {
        ...
        /// </summary>
        public FBlendSample[] SampleData { get; private set; } = Array.Empty<FBlendSample>();

        /// <summary>
        /// Grid samples, indexing scheme imposed by subclass
        /// </summary>
        public FEditorElement[] GridSamples { get; private set; } = Array.Empty<FEditorElement>();

        /// <summary>
        /// Blend Parameters for each axis.
        /// </summary>
        public FBlendParameter[] BlendParameters { get; private set; } = Array.Empty<FBlendParameter>();
        ...
        public override void Deserialize(FAssetArchive Ar, long validPos)
        {
            ...
            TryGetAllValues<FBlendParameter>(out var blendParameters, nameof(BlendParameters));
            BlendParameters = blendParameters ?? Array.Empty<FBlendParameter>();
        }
    }
}