...
public struct FCustomVersion : IEquatable<FCustomVersion>
{
    /** Unique custom key. */
    public FGuid Key;
    ...
    {
        return obj is FCustomVersion other && Equals(other);
    }

    public bool Equals(FCustomVersion other)
    {
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            return (Key.GetHashCode() * 397) ^ Version;
        }
    }
}
