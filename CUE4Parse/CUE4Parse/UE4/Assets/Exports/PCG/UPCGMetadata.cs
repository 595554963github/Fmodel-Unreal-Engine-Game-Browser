...
{
    public Dictionary<FName, FPCGMetadataAttributeBase> Attributes { get; private set; } = new Dictionary<FName, FPCGMetadataAttributeBase>();
    public long[] ParentKeys { get; private set; } = Array.Empty<long>();
