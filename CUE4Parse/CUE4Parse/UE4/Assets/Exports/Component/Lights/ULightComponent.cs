...
{
    public float AttenuationRadius { get; private set; } // Add this property

    public new ELightUnits IntensityUnits; // Use 'new' to explicitly hide the inherited member
    ...
    public override void Deserialize(FAssetArchive Ar, long validPos)
    {
        ...
        // Ensure Owner and Provider are not null before accessing DefaultLightUnit
        ...
        {
            IntensityUnits = ELightUnits.Unitless; // Fallback to a default value
        }
    }
