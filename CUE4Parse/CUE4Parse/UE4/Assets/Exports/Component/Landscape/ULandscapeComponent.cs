...
public class ULandscapeComponent : UPrimitiveComponent
{
    ...
    public ULandscapeComponent()
    {
        // Initialize all non-nullable fields
        WeightmapLayerAllocations = Array.Empty<FWeightmapLayerAllocationInfo>();
        WeightmapTextures = new Lazy<UTexture2D[]>(() => Array.Empty<UTexture2D>());
    }
    ...
    public override void Deserialize(FAssetArchive Ar, long validPos)
    {
        ...
        WeightmapTextures = new Lazy<UTexture2D[]>(() => GetOrDefault<UTexture2D[]>("WeightmapTextures", Array.Empty<UTexture2D>()));
    ...
    public UTexture2D? GetHeightmap() => GetOrDefault<UTexture2D>("HeightmapTexture", default!);
