...
{
    public FStaticMeshComponentLODInfo[] LODData = Array.Empty<FStaticMeshComponentLODInfo>();
    ...
    public override void Deserialize(FAssetArchive Ar, long validPos)
    {
        ...
        if (Ar.Game == Versions.EGame.GAME_无主之地3) Ar.ReadBoolean();
        LODData = Ar.ReadArray(() => new FStaticMeshComponentLODInfo(Ar)) ?? Array.Empty<FStaticMeshComponentLODInfo>();
