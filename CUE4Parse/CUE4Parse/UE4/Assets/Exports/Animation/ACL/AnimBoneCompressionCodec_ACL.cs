...
public class UAnimBoneCompressionCodec_ACL : UAnimBoneCompressionCodec_ACLBase
{
    ...
    public override UAnimBoneCompressionCodec? GetCodec(string ddcHandle)
    {
        ...
        if (codecMatch == null && SafetyFallbackCodec is not null &&
            SafetyFallbackCodec.TryLoad<UAnimBoneCompressionCodec>(out var safetyFallbackCodec) &&
            safetyFallbackCodec is not null)
        {
