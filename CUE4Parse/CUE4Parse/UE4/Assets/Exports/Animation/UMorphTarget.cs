...
public class FMorphTargetDelta
{
    ...
    public FMorphTargetDelta(FArchive Ar)
    {
        ...
        if (Ar.Game == EGame.GAME_星球大战银河猎手) Ar.Position += 4;
    }
...
public class FMorphTargetLODModel
{
    ...
    public int[] SectionIndices = new int[0];
    ...
    {
        Vertices = new FMorphTargetDelta[0];
        NumBaseMeshVerts = 0;
    ...
    {
        SectionIndices = new int[0]; // 初始化SectionIndices字段
        ...
        {
            if (Ar.Game == EGame.GAME_弗兰克斯通的阴影)
            {
...
{
    public FMorphTargetLODModel[] MorphLODModels = new[] { new FMorphTargetLODModel() };
