...
namespace CUE4Parse.UE4.Assets.Exports.Animation
{
    ...
    public class FSmartNameMapping
    {
        ...
        {
            // Initialize all dictionaries with empty collections
            GuidMap = new Dictionary<FName, FGuid>();
            UidMap = new Dictionary<ushort, FName>();
            CurveMetaDataMap = new Dictionary<FName, FCurveMetaData>();
