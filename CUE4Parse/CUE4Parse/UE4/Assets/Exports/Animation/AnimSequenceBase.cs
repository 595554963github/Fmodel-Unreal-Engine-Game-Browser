...
namespace CUE4Parse.UE4.Assets.Exports.Animation
{
    public abstract class UAnimSequenceBase : UAnimationAsset
    {
        ...
        public FAnimNotifyEvent[] Notifies = Array.Empty<FAnimNotifyEvent>();
        ...
        public override void Deserialize(FAssetArchive Ar, long validPos)
        {
            ...
            Notifies = GetOrDefault(nameof(Notifies), Array.Empty<FAnimNotifyEvent>()) ?? Array.Empty<FAnimNotifyEvent>();
