...
public class ULoudnessNRT : UObject
{
    ...
    public Dictionary<int, FLoudnessDatum[]> ChannelLoudnessArrays = new Dictionary<int, FLoudnessDatum[]>();
    public Dictionary<int, FFloatInterval> ChannelLoudnessIntervals = new Dictionary<int, FFloatInterval>();
