...
namespace CUE4Parse.UE4.Assets.Readers
{
    public class FObjectAndNameAsStringProxyArchive : FAssetArchive
    {
        ...
        public override object Clone() => new FObjectAndNameAsStringProxyArchive((FArchive)InnerArchive.Clone(), Owner, AbsoluteOffset);
        ...
        public override Lazy<T?> ReadObject<T>() where T : class
        {
            ...
            return new Lazy<T?>(() =>
            {
                if (Owner?.Provider == null) return null;
