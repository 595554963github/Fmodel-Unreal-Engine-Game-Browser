...
{
    private static readonly AesProvider Provider = AesProvider.Create();

    static RennsportAes()
    {
        Provider.Mode = CipherMode.CBC;
        Provider.Padding = PaddingMode.None;
        Provider.BlockSize = 16 * 8;
    }

    private static byte[] iv0 = new byte[] { 0x7C, 0x8D, 0x5C, 0x6C, 0x70, 0x52, 0xA2, 0x41, 0x0C, 0xA5, 0xC3, 0x70, 0xB9, 0x9D, 0x23, 0x3B };
    private static byte[] iv1 = new byte[] { 0x75, 0x7C, 0xE4, 0x79, 0x62, 0xF4, 0xC7, 0x28, 0xF9, 0x89, 0x83, 0x6F };
    private static byte[] iv2 = new byte[] { 0xD1, 0xDC, 0x32, 0x32, 0x8E, 0xB3, 0x7F, 0xE2, 0x76, 0x49, 0xC9, 0xDC };
    //private static byte[] iv3 = new byte[] { 0x5E, 0x7B, 0x71, 0x28, 0x7E, 0x37, 0xDE, 0xDB, 0xAC, 0x2B, 0xEA, 0xD3 };
