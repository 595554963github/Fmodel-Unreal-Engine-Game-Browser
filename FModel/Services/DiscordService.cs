...
namespace FModel.Services
{
    ...
    public class DiscordHandler
    {
        ...
        public void Initialize(string gameName)
        {
            ...
            _client.OnReady += (_, args) => Log.Information("@{Username} ({UserId})现在已准备就绪", args.User.Username, args.User.ID);
        ...
        public void UpdatePresence(CUE4ParseViewModel viewModel) =>
            UpdatePresence(
                ...
                $"Mode: {UserSettings.Default.LoadingMode.GetDescription()} - {viewModel.SearchVm.ResultsCount:### ### ###}加载资源".Trim());
