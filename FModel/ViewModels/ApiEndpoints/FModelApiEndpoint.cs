...
public class FModelApiEndpoint : AbstractApiProvider
{
    ...
    public void CheckForUpdates(bool launch = false)
    {
        ...
        {
            Log.Warning("更新已被静音，直到{DateTime}", UserSettings.Default.NextUpdateCheck);
            return;
        }
